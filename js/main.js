...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/gsap */ "./src/js/libs/gsap.js");
//Подробная документация внутри каждой функции/библиотеки
// Свайпер
// import "./libs/swiper";
// Gsap
...
window.addEventListener("load", function () {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".hero__title", {
    x: "-100%",
    opacity: 0,
    delay: 0.5
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".hero__btn", {
    x: "-100%",
    opacity: 0,
    delay: 1
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".header__nav", {
    y: "-100%",
    opacity: 0,
    delay: 0.5
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".hero__text", {
    x: "100%",
    opacity: 0,
    delay: 0.8
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".hero__social-list", {
    x: "100%",
    opacity: 0,
    delay: 0.8
  });
